...
public class AlgorithmGenericBuilder {
    ...
    public AlgorithmGenericBuilder setProblem(ISchedulingProblem problem) {
        this.problem = problem;
        return this;
    }

    public AlgorithmGenericBuilder findSpecificAlgorithm(String algorithmName) {
        this.algorithmToInstatiate = AlgorithmUtils.getAlgorithmClass(algorithmName);
        return this;
    }
    ...
    public AlgorithmGenericBuilder getMaxMethod() throws AlgorithmsException, SchedulingOptimizerException {

        this.setMaxEvaluations = AlgorithmUtils.getMaxMethod(this.algorithmToInstatiate);
    ...
    public AlgorithmGenericBuilder setInstance() throws AlgorithmsException {
        ...
        HashMap<Class, Object> paramsByType = AlgorithmUtils.getDefaultParams((Problem) problem);
    ...
    private AlgorithmGenericBuilder setParams(HashMap<Class, Object>  parameterTypes) {
        try{
            Method crossoverMethod = AlgorithmUtils.getMethodOnAlgorithmBuilder("setCrossoverOperator", this.algorithmToInstatiate, CrossoverOperator.class);
            crossoverMethod.invoke(this.algorithmInstance,parameterTypes.get(CrossoverOperator.class));

            Method mutationMethod = AlgorithmUtils.getMethodOnAlgorithmBuilder("setMutationOperator", this.algorithmToInstatiate, MutationOperator.class);
            mutationMethod.invoke(this.algorithmInstance, parameterTypes.get(MutationOperator.class));

            Method selectionMethod = AlgorithmUtils.getMethodOnAlgorithmBuilder("setSelectionOperator", this.algorithmToInstatiate, SelectionOperator.class);
            selectionMethod.invoke(this.algorithmInstance, parameterTypes.get(SelectionOperator.class));

            Method evaluatorMethod = AlgorithmUtils.getMethodOnAlgorithmBuilder("setSolutionListEvaluator", this.algorithmToInstatiate, SolutionListEvaluator.class);
